...
const PERSONAS = {
  personas: [
    { id: "cowork", name: "MeowWorker", icon: "cowork", tagline: "Produce a deliverable — research, analysis, scripts", needs_workspace: true, builtin: true, family: "knowledge", workspace: "deliverable", tools: ["files", "search"], enabled: true, surfaced: true, default: true },
...
const PINNED_SESSION = {
  ...
  workspace: "/Users/test/MeowWorker/launch-note",
  agent: "cowork",
  model: "anthropic:claude-opus-4-8",
  mode: "interactive",
...
const OPS_SESSION = {
  session_id: "ops-1",
  title: "Ops triage",
  workspace: "/Users/test/MeowWorker/ops-triage",
  agent: "ops",
  model: "anthropic:claude-opus-4-8",
  mode: "interactive",
...
const PRIMARY_ROOT = { path: "/Users/test/MeowWorker/launch-note", writable: true, label: "scratch", primary: true, exists: true };
