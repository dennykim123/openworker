...
const SETTINGS = {
  ...
  nav_layout: "grouped",
  scratch_base: "~/OpenWorker Subscription Bridge",
...
const PERSONAS = {
  personas: [
    { id: "cowork", name: "OpenWorker Subscription Bridge", icon: "cowork", tagline: "Produce a deliverable — research, analysis, scripts", needs_workspace: true, builtin: true, family: "knowledge", workspace: "deliverable", tools: ["files", "search"], enabled: true, surfaced: true, default: true },
...
const PINNED_SESSION = {
  ...
  workspace: "/Users/test/OpenWorker Subscription Bridge/launch-note",
  agent: "cowork",
  model: "anthropic:claude-opus-4-8",
  mode: "interactive",
...
const OPS_SESSION = {
  session_id: "ops-1",
  title: "Ops triage",
  workspace: "/Users/test/OpenWorker Subscription Bridge/ops-triage",
  agent: "ops",
  model: "anthropic:claude-opus-4-8",
  mode: "interactive",
...
const PERSONA_DETAIL = {
  id: "cowork",
  name: "OpenWorker Subscription Bridge",
  icon: "cowork",
...
const PRIMARY_ROOT = { path: "/Users/test/OpenWorker Subscription Bridge/launch-note", writable: true, label: "scratch", primary: true, exists: true };
