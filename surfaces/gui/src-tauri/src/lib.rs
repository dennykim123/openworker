//! MeowWorker desktop shell, built on OpenWorker.
//!
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            let open_i = MenuItem::with_id(app, "open", "Open MeowWorker", true, None::<&str>)?;
        ...
        .expect("error while building the MeowWorker desktop app")
        .run(|app, event| {
